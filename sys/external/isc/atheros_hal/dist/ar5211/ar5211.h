...
extern	HAL_BOOL ar5211PerCalibrationN(struct ath_hal *ah,t HAL_CHANNEL *chan,
		u_int chainMask, HAL_BOOL longCal, HAL_BOOL *isCalDone);
extern	HAL_BOOL ar5211ResetCalValid(struct ath_hal *ah, HAL_CHANNEL *);
...
extern	void ar5211RxMonitor(struct ath_hal *, const HAL_NODE_STATS *,
		HAL_CHANNEL *);
extern	void ar5211AniPoll(struct ath_hal *, HAL_CHANNEL *);
